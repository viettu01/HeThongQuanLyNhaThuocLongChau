...
ALTER TABLE dbo.tbl_SanPham ADD FK_sNhaCungCap VARCHAR(10) NOT NULL CONSTRAINT FK_SanPham_NhaCungCap FOREIGN KEY REFERENCES dbo.tbl_NhaCungCap(PK_sMaNCC)